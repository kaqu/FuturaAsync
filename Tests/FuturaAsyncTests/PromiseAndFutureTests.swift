...
////            XCTAssert(promise.future.isCompleted == false, "Promise completed before completing")
////            XCTAssert(promise.future.isCompleted == false, "Future completed before completing")
////            try? promise.fulfill(with: ())
////            XCTAssert(promise.future.isCompleted == true, "Promise not completed after completing")
